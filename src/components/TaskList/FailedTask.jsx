...
const FailedTask = ({data}) => {
  return (
    <div className="flex-shrink-0 w-[260px] sm:w-[300px] md:w-full p-5 bg-yellow-400 rounded-xl">
      ...
      <div className="mt-6">
        <button className="w-full bg-red-500 rounded font-medium py-1 px-2 text-xs sm:text-sm">Failed</button>
      </div>
    </div>
  )
}
